class JogoDaVelha:
    ...
    def verificar_jogada(self, jogada):  # verificar se a jogada é válida
    ...
    def jogar (self):
        ...
        while True:
            ...
            print(f"Turno do {self.turno}, qual a sua jogada?")

            # enquanto o jogador não fizer uma jogada válida
            while True:
                jogada = input("Jogada: ")

                if self.verificar_jogada(jogada):  # se a jogada for valida...
            ...
            # troca de jogador do próximo turno
